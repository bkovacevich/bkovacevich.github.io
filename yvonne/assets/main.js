...
(function() {
	...
	// Initialize "On Visible" animations.
		onvisible.add('.image.style1', { style: 'fade-in', speed: 1000, intensity: 5, threshold: 3, delay: 0, replay: false });
		onvisible.add('h1.style4, h2.style4, h3.style4, p.style4', { style: 'fade-right', speed: 1000, intensity: 5, threshold: 3, delay: 0, replay: false });
		onvisible.add('h1.style5, h2.style5, h3.style5, p.style5', { style: 'fade-left', speed: 1000, intensity: 5, threshold: 3, delay: 0, replay: false });
		onvisible.add('h1.style6, h2.style6, h3.style6, p.style6', { style: 'fade-in', speed: 1000, intensity: 5, threshold: 3, delay: 0, replay: false });
		onvisible.add('.buttons.style1', { style: 'zoom-out', speed: 1000, intensity: 5, threshold: 3, delay: 0, stagger: 375, staggerSelector: ':scope > li', replay: false });
		onvisible.add('h1.style3, h2.style3, h3.style3, p.style3', { style: 'fade-right', speed: 1000, intensity: 5, threshold: 3, delay: 0, replay: false });
		onvisible.add('h1.style1, h2.style1, h3.style1, p.style1', { style: 'fade-left', speed: 1000, intensity: 5, threshold: 3, delay: 0, replay: false });
		...
		onvisible.add('.icons.style2', { style: 'zoom-out', speed: 1000, intensity: 5, threshold: 3, delay: 0, stagger: 250, staggerSelector: ':scope > li', replay: false });
